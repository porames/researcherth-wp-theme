 ...
 */
function researcherth_customize( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'header_logo', array(
		'label'       => __( 'Upload Header Logo', 'researcherth' ),
		'description' => __( 'Height: &gt;80px', 'researcherth' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar Scheme', 'researcherth' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'navbar-light bg-light'  => __( 'Default', 'researcherth' ),
						'navbar-dark bg-dark'    => __( 'Dark', 'researcherth' ),
						'navbar-dark bg-primary' => __( 'Primary', 'researcherth' ),
					),
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar', 'researcherth' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'static'       => __( 'Static', 'researcherth' ),
						'fixed_top'    => __( 'Fixed to top', 'researcherth' ),
						'fixed_bottom' => __( 'Fixed to bottom', 'researcherth' ),
					),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'     => 'checkbox',
		'label'    => __( 'Show Searchfield?', 'researcherth' ),
		'section'  => 'theme_header_section',
		'settings' => 'search_enabled',
		'priority' => 3,
	) );
}
add_action( 'customize_register', 'researcherth_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function researcherth_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'researcherth_customize_preview_js' );
